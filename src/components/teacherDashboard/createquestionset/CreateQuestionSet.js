...
import questionsData from "../../../db/databases/questions.json";
...
import { createNewQuestion, updateQuestion } from '../../../model/questions'
...
function CreateQuestionSet({assgnmntId}) {
  ...
  const createAssignment = async() => {
   ...
   try {         
          ...
          console.log("assgnmntId: ", assgnmntId, typeof(assgnmntId));
          createNewQuestion(questions)
          .then((result)=>{
            const question_id = result;
            console.log("Question successfully inserted and the id is: ", question_id);
          })
          .catch((err)=>{
            console.log("error while inserting questions: ", err);
          })
              ...
              <div>
                ...
                <label style={{ marginLeft: "2px" }}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestion(index, "max_number_of_attempts", e.target.value)
                    }
                  />                 
                </label>
